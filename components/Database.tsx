...
const PLANT_DB: Plant[] = [
  { name: 'Gʻoʻza (Paxta)', category: 'Texnik', img: 'https://images.unsplash.com/photo-1590059530493-271ece40ca17?auto=format&fit=crop&w=600&q=80', diseases: ['Vilt', 'Shira', 'Bakterial kuyish', 'Kuzgi tunlam'], risk: 'High', origin: 'Fargʻona', description: 'Gʻoʻza Oʻzbekistonning asosiy texnik ekini boʻlib, asosan toʻqimachilik sanoati va yogʻ ishlab chiqarishda ishlatiladi. Issiq va yorugʻsevar oʻsimlik. Vegetatsiya davri iqlimga qarab 110-140 kunni tashkil etadi.' },
  ...
  { name: 'Uzum', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Grapes_during_pigmentation.jpg/600px-Grapes_during_pigmentation.jpg', diseases: ['Oidium', 'Mildyu', 'Kul', 'Antraknoz'], risk: 'Medium', origin: 'Parkent', description: 'Tokchilik - mamlakatimiz qishloq xoʻjaligining asosiy tarmoqlaridan biri. Uzumni meva, mayiz va vitikultura mahsulotlari sifatida saqlash va sotish qulay boʻlgan yuqori rentabelli ekin.' },
  { name: 'Anor', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Pomegranate_fruit_02.jpg/600px-Pomegranate_fruit_02.jpg', diseases: ['Don chirishi', 'Meva biti', 'Barg toʻkilishi'], risk: 'Low', origin: 'Quva', description: 'Subtropik hududlar uchun moslashgan shifobaxsh meva. Issiqqa gʻoyat chidamli, suvga esa nisbatan talabchan. Daraxtlari toʻgʻri shakl berishni va tuproqni yumshatishni yaxshi koʻradi.' },
  { name: 'Anjir', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Ficus_carica_fruit_02.jpg/600px-Ficus_carica_fruit_02.jpg', diseases: ['Barg zangi', 'Anjir shirasi'], risk: 'Low', origin: 'Xiva', description: 'Juda shirin, foydali vitaminlar xazinasi. Kuzda pishib yetiladi, barglari xalq tabobatida turli sharbatlar qilib ichiladi. Issiqlik harorati barqaror boʻlgan hududlarda yaxshi koʻkaradi.' },
  { name: 'Shaftoli', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Autumn_Red_peaches.jpg/600px-Autumn_Red_peaches.jpg', diseases: ['Barg bujmayishi', 'Moniolioz', 'Zang'], risk: 'High', origin: 'Fargʻona', description: 'Turli iqlim injiqliklariga tez taʼsir qiluvchi subtropik oʻsimlik. Ertapisharligi va yuqori darajadagi taʼm sifatiga ega ekani bilan mashhur, koʻpincha sovuq shamollardan ehtiyot qilinadi.' },
  { name: 'Qovun', category: 'Poliz', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Muskmelon_Plant.jpg/600px-Muskmelon_Plant.jpg', diseases: ['Oq chirish', 'Qovun pashshasi', 'Ildiz chirishi'], risk: 'High', origin: 'Mirzachoʻl', description: 'Uzoq quyoshda yetilishi bilan birga uzoq masofaga transportirovka ham qilinadi. Ekish oldidan tuproq qumloq, serunum va yaxshi ob-havo hududlar tavsiya qilinadi.' },
  ...
  { name: 'Oʻrik', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Apricot_Fruit_Development.jpg/600px-Apricot_Fruit_Development.jpg', diseases: ['Klyasterosporioz', 'Monilioz chirish'], risk: 'Medium', origin: 'Samarqand', description: 'Yoz chillasiga qadar toʻliq hosili terib olinadigan shirin meva. Ayniqsa turshak tayyorlash uchun sanoat ahamiyatiga koʻra mamlakatimiz iqtisodida alohida oʻringa ega.' },
  { name: 'Yongʻoq', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Juglans_regia_fruit_02.jpg/600px-Juglans_regia_fruit_02.jpg', diseases: ['Bakterioz', 'Antraknoz', 'Yongʻoq kuyasi'], risk: 'Low', origin: 'Boʻstonliq', description: 'Asosan togʻ va togʻ oldi mintaqalarida unib chiquvchi, oqsil va omega-3 yogʻ kislotalariga boy daraxt. Hosil olinishi kech boʻlsada, daraxtning mahsuldorligi va yogʻochining qiymati uzoq yillik.' },
  { name: 'Limon', category: 'Meva', img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Lemon.jpg/600px-Lemon.jpg', diseases: ['Gommoz', 'Meva toʻkilishi', 'Sitrus trips'], risk: 'Medium', origin: 'Toshkent', description: 'Issiqlik, parnik va faqat nam tuproqda yetiluvchi efir moyli va sitrus mevalar sinfiga kiruvchi nav. C vitamini bilan sovuqning oldini olishda tibbiyotning eng qadimgi retsepti.' },
